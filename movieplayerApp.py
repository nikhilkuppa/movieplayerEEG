...
class InitialScreen:
    ...
    def setup_ui(self):
        ...
        self.movie_info = pd.read_excel(r'T_movie_information.xlsx')
    ...
    def submit_stim_id(self):
        ...
        self.scenes_info = pd.read_excel(r'T_scene_combined.xlsx')
...
class VideoPlotterApp:
    ...
    def update_plot(self):
        video_dir = f'stimuli\\Scenes_corrected\\{self.stim_title}'
